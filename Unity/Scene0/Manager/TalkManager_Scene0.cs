...
// 대화 매니저
public class TalkManager_Scene0 : MonoBehaviour {
    // 게임 매니저
    public GameManager_Components GameManager;
    // 대화 내용 데이터
    public TalkDictionary_Scene0 TalkDictionary;
    // 퀘스트 매니저
    public QuestManager_Scene0 QuestManager;
    // 대화창 전체
    ...
    void Talk(int id, bool isNpc) {
        ...
        if(talkData == null){
            ...
            if(QuestManager.questId == 0 && talkIndex == 1){
                nextChat = false;
            }else{
                nextChat = true;
            }
        ...
        Debug.Log(questTalkIndex + " : " + talkIndex);
