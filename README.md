...
| **박한훈 😆** |  **Front-End<br>Unity**  | **- 담당 섬 : 소비 섬**<br>- 기능: 공통 코드 컴포넌트 및 기본 틀 구성, 대화 및 퀘스트 시스템 구축, 대화 분기점(선택창), Fade In/Out, 오브젝트 추적 네비게이션, 별 모으기 게임, 스탬프 배경, WebGl 파일 다운로드<br>- 기타 : README.md 작성 |
