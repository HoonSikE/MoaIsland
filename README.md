...
<div align="center">
   <img src="./README/TechnicalStack/TechnicalStack.png" width="95%">
</div>
...
| **김민정 😀** | **Front-End<br>Unity** | **- 담당 섬 : 퀴즈**<br>- 기능 : 현위치 지도, 퀴즈, 파일 다운로드<br>- 기타 : . |
| **박채림 🤗** |  **Back-End<br>Unity**  | **- 담당 섬 : 은행 섬**<br>- 기능: 사인<br>- 기타 : PPT 자료 구성 및 발표 |
| **박한훈 😆** |  **Front-End<br>Unity**  | **- 담당 섬 : 소비 섬**<br>- 기능: .<br>- 기타 : ReadMe 작성 |
| **오도석 🙄** |  **Back-End<br>Unity**  | **- 담당 섬 : 세금 섬**<br>- 기능: 캐릭터 퀘스트 대화창<br>- 기타 : 포팅메뉴얼 |
| **이병헌 😎** |  **Front-End<br>Unity**  | **- 담당 섬 : 주식 섬**<br>- 기술: . <br>- 기타 : PPT 자료 구성 및 발표 |
| **최연지 😄** |  **Back-End<br>Unity**  | **- 담당 섬 : 튜토리얼 섬**<br>- 기술: .<br>- 기타 : . |
